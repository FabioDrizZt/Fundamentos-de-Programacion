...
switch(opcion) {
  case 1: alert("La suma es: " + (num1 + num2)); break;
  case 2: alert("La resta es: " + (num1 - num2)); break;
  case 3: alert("La multiplicación es: " + (num1 * num2)); break;
  default: alert("Opción no válida. Por favor, reinicia y elige 1, 2 o 3.");
}
